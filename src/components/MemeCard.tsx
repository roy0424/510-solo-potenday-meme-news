...
export default function MemeCard({ result }: MemeCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10 mt-6 md:mt-10 animate-fade-in">
      ...
      {/* Summary - 서브 */}
      <div className="mb-6 md:mb-8 p-5 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl border-l-4 border-orange-400">
        <h3 className="text-sm font-semibold text-orange-600 mb-2 md:mb-3 uppercase tracking-wide">📰 뉴스 요약</h3>
        <p className="text-base md:text-lg font-semibold text-gray-800 leading-relaxed">{result.summary}</p>
      </div>
